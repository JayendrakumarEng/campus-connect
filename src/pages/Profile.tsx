              ...
              <div className="flex flex-col items-center text-center sm:flex-row sm:text-left sm:items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mt-3">
                    {profile.github_url && (
                      <a href={profile.github_url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-all hover:scale-110">
                        <Github className="h-5 w-5" />
                      </a>
                    )}
                    {profile.linkedin_url && (
                      <a href={profile.linkedin_url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-all hover:scale-110">
                ...
                <div>
                  {isOwn ? (
                    ...
                    <Button size="sm" variant={isFollowing ? 'secondary' : 'default'} onClick={toggleFollow} className="rounded-xl">
            ...
            <Card className="mt-6 glass-card rounded-2xl">
              <CardContent className="pt-6">
                ...
                <div className="space-y-3">
                  {profile.resume_url && (
                    <a href={profile.resume_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 rounded-xl border border-border/30 p-3 hover:bg-accent/30 transition-all hover:translate-x-1">
                  ...
                  {profile.portfolio_url && (
                    <a href={profile.portfolio_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 rounded-xl border border-border/30 p-3 hover:bg-accent/30 transition-all hover:translate-x-1">
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              {projs.map((p: any, i: number) => (
                                <div key={i} className="rounded-xl border border-border/30 p-3 hover:bg-accent/20 transition-colors">
