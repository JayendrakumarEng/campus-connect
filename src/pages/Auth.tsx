    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <Button
            variant="outline"
            className="w-full mb-4 h-12 text-base font-medium border-2 hover:bg-accent/50 hover:border-primary/30 transition-all duration-200 shadow-sm hover:shadow-md gap-3"
